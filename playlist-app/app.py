...
def add_song_to_playlist(playlist_id):
    ...
    #get song IDs in the current playlist
    curr_on_playlist_ids = [song.id for song in playlist.songs]

    # Restrict form to songs not already on this playlist
    available_songs = Song.query.filter(Song.id.notin_(curr_on_playlist_ids)).all()
